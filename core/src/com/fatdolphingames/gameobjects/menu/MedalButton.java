...
public class MedalButton extends MenuButton {

    public MedalButton(GameWorld world, float x, float y, int width, int height, float offsetX, float offsetY) {
    ...
    @Override
    public void save() {
        // TODO Save current medal.
    }

    @Override
    public void draw(SpriteBatch batcher, ShapeRenderer shapeRenderer, BitmapFont font, BitmapFont outline, float runTime) {
        // TODO Draw currently selected medal.
