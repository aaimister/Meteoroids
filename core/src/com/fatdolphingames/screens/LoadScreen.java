...
public class LoadScreen implements Screen {
    ...
    public LoadScreen(MGame game, TweenManager tweenManager, SpriteBatch batcher, float width, float height, float scale) {
        ...
        meteor01.setColor(AssetLoader.getColor(29.0f, 29.0f, 29.0f, 1.0f));
        ...
        o01.setColor(AssetLoader.getColor(29.0f, 29.0f, 29.0f, 1.0f));
        o01.setAlpha(0.0f);
        ...
        meteor02.setColor(AssetLoader.getColor(29.0f, 29.0f, 29.0f, 1.0f));
        ...
        o02.setColor(AssetLoader.getColor(29.0f, 29.0f, 29.0f, 1.0f));
        o02.setAlpha(0.0f);
